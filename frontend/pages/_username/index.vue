...
import mainView from '~/components/widgets/views/mainView'
import mainView2 from '~/components/widgets/views/mainView2'
import mainView3 from '~/components/widgets/views/mainView3'
import mainView4 from '~/components/widgets/views/mainView4'
import mainView5 from '~/components/widgets/views/mainView5'

import display1 from '~/pages/display/service1'
import cardView from '~/components/widgets/views/cardView'
import cardView2 from '~/components/widgets/views/cardView2'
import cardView3 from '~/components/widgets/views/cardView3'
export default {
    layout: 'landing',
    data(){
        return{
