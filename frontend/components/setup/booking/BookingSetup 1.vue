...
<!-- Registered Booking Display-->
    ...
    <div>
            ...
            <v-chip-group v-for="(d, i) in this.bookingData" :key="i">
    ...
    methods: {
        ...
        getFullData(selectedDate){
            ...
            for(var i=0;i<this.book.length;i++){
                    ...
                    timeObject.time.push({hour: hours+":"+minutes, booking: true, count: 1})   // onSave()시  booking이 무조건 true로 ㅂ바뀜.
        ...
        this.book[i].time.find(function(e){ if(e.hour === hour){  
        e.booking = !e.booking }})
        }
