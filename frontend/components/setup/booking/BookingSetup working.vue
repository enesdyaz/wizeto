    ...
    <div>
        <table class='body-1'>  
            <tr>
                <th>Available</th> 
                <td>
                    <select v-model='period'  style='font-size: 0.8rem; border: 1px solid grey; width: 90%; padding-left: 10px;' type="number" min='1'>
...
<!-- Registered Booking Display-->
    <div>
            ...
            <div style='float: right'>
                <v-btn class='mt-4' color='indigo' dark small @click='onSave()'>Update</v-btn> <v-btn class='mt-4' color='blue-grey' dark small>RESET</v-btn>
            </div>
